...
def _(mo):
    mo.md(r"""
    # marimo-dev.build_pkg

    Consumes a Project and writes a Python package.
    No ast. No tomllib. No re-reading files.
    Just traversal and text assembly.

    Public API:
        build(project) -> str
        bundle(project, name) -> str
    """)
    return
