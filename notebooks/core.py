...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Scan /notebooks Directory""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Documentation Converter""")
    return
...
def _():
    ...
    print("=" * 60)
    convert_library_docstyle('src/m_dev', target_style='google', backup=True)
    print("=" * 60)
...
@app.cell
def _():
    build_package("./notebooks", output_dir="src", docstring_style="nbdev")
    return
