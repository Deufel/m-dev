...
class ModuleInfo(TypedDict):
    ...
    export_names:list[str]  # names to re-export
...
class ScanResult(TypedDict):
    ...
    index_path:str|None       # path to index notebook (for README)
...
def _(mo):
    mo.md(r"""
    ## Internal helpers
    > u_ = util / internal – never exported, always callable in marimo
    """)
    return
...
@app.cell
def _():
    build(nb_dir="notebooks/", out="test5", style="google")
    return
