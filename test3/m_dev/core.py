...
"""
Args:
    notebook_path (str): List of exported function/class names
"""
...
Args:
    ...
    setup_imports (list): Add this parameter
    eval_str (bool): Weather to eval strings or not...idk the idfference. 
"""
    clean_source: str,          # Function source code (without decorators)
    func_name: str,             # Name of the function to extract docs from
...
"""
Args:
    source (str): Returns list of strings
"""
